...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const tr = () => getLanguage() === "ms" ? {
        ...
        name: "Nama *", phone: "Nombor telefon *", email: "E-mel *", location: "Lokasi pemasangan *", notes: "Nota tambahan",
        ...
        name: "Name *", phone: "Phone number *", email: "Email *", location: "Installation location *", notes: "Additional notes",
    ...
    ${getLanguage() === "ms" ? "Semak Permintaan →" : "Review Request →"}
        ...
        if (screen === 7) {
            ...
            const rows = [
                ...
                [t.email.replace(" *", ""), customer.email],
